...
Proyek ini dibuat sebagai upaya untuk meningkatkan keamanan pada barang-barang pribadi. Proyek ini telah dilaksanakan dan memakan waktu kurang lebih 1 bulan. Adapun dalam proyek ini, papan pengembangan yang digunakan ada 2 yaitu Arduino Pro Micro dan Wemos D1 Mini. Arduino Pro Micro berperan sebagai penampung data koordinat. Data yang ditampung kemudian dikirimkan ke Wemos D1 Mini melalui UART: Hardware Serial. Data yang diterima oleh Wemos D1 Mini melalui UART: Software Serial inilah yang disebut data mentah. Data mentah ini terus diolah menjadi data yang berguna dan dikirimkan ke Bot Telegram yang merupakan antarmuka sistem. Bot Telegram akan merespon jika terdapat interaksi. Manfaat yang diperoleh dari proyek ini adalah letak koordinat suatu barang dapat dicari dan dapat dipantau sepanjang waktu asalkan perangkat GPS tidak rusak, sehingga barang tersebut tidak akan mudah dicuri.
