...
Pencurian barang saat ini marak terjadi di Indonesia. Hal ini bisa terjadi karena kurangnya kesadaran pengguna atau lalai dalam menjaga barang pribadinya. Oleh karena itu, proyek ini dibuat pada dasarnya untuk meningkatkan keamanan pada suatu barang. Proyek ini telah dilaksanakan dan memakan waktu kurang lebih 1 bulan. Ada 2 jenis papan pengembangan yang dipakai. Arduino Pro Micro dipakai untuk menampung data koordinat yang diperoleh dari sensor, kemudian juga dipakai untuk mengirimkan data mentah ke Wemos D1 Mini. Pengiriman data tersebut menggunakan protokol komunikasi UART: Hardware Serial. Sedangkan Wemos D1 Mini dipakai untuk menerima data koordinat dari Arduino Pro Micro. Penerimaan data tersebut menggunakan protokol komunikasi UART: Software Serial. Selain itu, Wemos D1 Mini juga dipakai untuk mengirimkan informasi berupa posisi barang ke Bot Telegram. Bot Telegram ini dapat merespon pengguna jika ada interaksi. Manfaat yang diperoleh yaitu memudahkan pengguna untuk memantau letak koordinat suatu barang sehingga tidak lagi mudah untuk dicuri.
