...
Proyek ini dibuat sebagai upaya dalam meningkatkan keamanan pada barang-barang pribadi. Proyek ini telah dilaksanakan dan memakan waktu kurang lebih 1 bulan. Penulis menggunakan 2 jenis papan pengembangan: Arduino Pro Micro dan Wemos D1 Mini. Arduino Pro Micro dalam proyek ini dipakai untuk menampung data koordinat yang diperoleh dari sensor. Selain itu, Arduino Pro Micro juga dipakai untuk keperluan pengiriman data ke Wemos D1 Mini. Pengiriman data tersebut menggunakan protokol komunikasi UART: Hardware Serial. Sedangkan Wemos D1 Mini dalam proyek ini dipakai untuk menerima data koordinat dari Arduino Pro Micro. Penerimaan data tersebut menggunakan protokol komunikasi UART: Software Serial. Selain itu, Wemos D1 Mini juga dipakai untuk keperluan pengiriman informasi ke Bot Telegram yang merupakan antarmuka sistem. Bot Telegram ini akan merespon jika pengguna telah berinteraksi. Manfaat yang diperoleh dari proyek ini adalah letak koordinat suatu barang dapat dicari dan dapat dipantau sepanjang waktu asalkan perangkat GPS tidak rusak, sehingga barang tersebut tidak akan mudah dicuri.
